...
{
    public partial class frm2Dsingle : Form
    {
        public frm2Dsingle()
        {
            InitializeComponent();
        ...
        private void pic1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (blnDraw)
            {
                ...
                //g.DrawRectangle(new Pen(pic1.BackColor,(float)pointwidth2), start.X, start.Y, end.X - start.X, end.Y - start.Y);
                end.X = e.X;
                end.Y = e.Y;
        ...
        private void frm2Dsingle_MouseMove(object sender, MouseEventArgs e)
        {
